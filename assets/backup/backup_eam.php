              ...
              <div class="box-body">
                    ...
                    <table id="example" class="table">
                      ...
                      <tbody>
                        ...
                        $result = mysqli_query($con,
                          ...
                          FROM tb_upload_logbook a $where GROUP BY a.CIF, a.month_logbook ORDER BY a.id_logbook LIMIT $page_size OFFSET $page
                          ");
                        ...
                        if($jumlah>0){
                          ...
                          while($row = mysqli_fetch_array($result))
                          {
                            ...
                            if ($row['CIF']==$row['CIF2']){
                             ...
                             echo "<td style='background-color: #1d2f61;'><font style='color: #f0ad4e'>CIF</font></td>";
                           }
                           if ($row['BIDANG_USAHA']==''){
                            echo "<td style='background-color: #1d2f61;'><font style='color: #f0ad4e'>CIF</font></td>";
                          }else{
                ...
                <div class="dataTables_paginate paging_bootstrap">
                  <ul class="pagination">
                    ...
                    <?php 
                    $get = mysqli_query($con,"SELECT COUNT(id_logbook) AS jumlah FROM tb_upload_logbook $where GROUP BY a.CIF, a.month_logbook ORDER BY id_logbook ASC");
