...
if (isset($_POST["submit_log"])) {  
  ...
  $uploaddir = './assets/file/csv_commercial/';
  ...
  if ($query) {
    if (mysql_query("LOAD DATA LOCAL INFILE '$uploadfile'
      ...
      header("Location: ./mdr_upload_Commercial.php?ntf=5");
    } else{
...
if (isset($_POST["submit_wa"])) {  
  ...
  if ($query) {
    if (mysql_query("LOAD DATA LOCAL INFILE '$uploadfile'
      ...
      ")) {
      mysql_query("UPDATE tb_logbook set data_by = '$user_login' where data_by IS NULL");
      header("Location: ./mdr_upload_Commercial.php?ntf=6");
    } else{
      echo "submit data failed".mysql_error();
    }
  } else {
...
if (isset($_POST["submit_bd"])) {  
  ...
  if ($query) {
    if (mysql_query("LOAD DATA LOCAL INFILE '$uploadfile'
      ...
      ")) {
      mysql_query("UPDATE tb_logbook set data_by = '$user_login' where data_by IS NULL");
      header("Location: ./mdr_upload_Commercial.php?ntf=4");
    } else{
      echo "submit data failed".mysql_error();
    }
  } else {
...
if (isset($_POST["submit_sectorusaha"])) {  
  ...
  if ($query) {
    if (mysql_query("LOAD DATA LOCAL INFILE '$uploadfile'
      ...
      ")) {
      mysql_query("UPDATE tb_logbook set data_by = '$user_login' where data_by IS NULL");
      header("Location: ./mdr_upload_Commercial.php?ntf=7");
    } else{
      echo "submit data failed".mysql_error();
    }
  } else {
...
if (isset($_POST["submit_yoyo"])) {  
  ...
  if ($query) {
    if (mysql_query("LOAD DATA LOCAL INFILE '$uploadfile'
      ...
      ")) {
      mysql_query("UPDATE tb_logbook set data_by = '$user_login' where data_by IS NULL");
      header("Location: ./mdr_upload_Commercial.php?ntf=9");
    } else{
      echo "submit data failed".mysql_error();
    }
  } else {
    ...
    <div class="content-wrapper">
      <section class="content">
        <ol class="breadcrumb">
          ...
          <li><a href="./mdr_upload_Commercial.php?ntf=0"><b>Admin Tools</b></a></li>
          <li class="active"><b>Upload CSV Commercial</b></li>
        </ol>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="box box-danger">
              <div class="box-body">
                ...
                <form name="postform" action=" " enctype='multipart/form-data' method="post">
                  ...
                  <button id="submit_log" type="submit" name="submit_log" value="submit_log" class="btn btn-success btn-block btn-flat">Upload CSV FILE LogBook</button>                        
                </form><br>
                ...
                <form name="postform" action=" " enctype='multipart/form-data' method="post">
                  ...
                  <button id="submit_wa" type="submit" name="submit_wa" value="submit_wa" class="btn btn-success btn-block btn-flat">Upload CSV FILE Watchlist</button>                        
                </form><br>
                ...
                <form name="postform" action=" " enctype='multipart/form-data' method="post">
                  ...
                  <button id="submit_bd" type="submit" name="submit_bd" value="submit_bd" class="btn btn-success btn-block btn-flat">Upload CSV FILE Bidang Usaha</button>                        
                </form><br> 
                ...
                <form name="postform" action=" " enctype='multipart/form-data' method="post">
                  ...
                  <button id="submit_sectorusaha" type="submit" name="submit_sectorusaha" value="submit_sectorusaha" class="btn btn-success btn-block btn-flat">Upload CSV FILE Sector Usaha</button>                        
                </form><br>
                ...
                <form name="postform" action=" " enctype='multipart/form-data' method="post">
                  ...
                  <button id="submit_yoyo" type="submit" name="submit_yoyo" value="submit" class="btn btn-success btn-block btn-flat">Upload CSV FILE Yoyo</button>                        
                </form><br>
              </div><!-- /.box-body -->
            </div><!-- /.box -->
