...
header("Content-Disposition: attachment;Filename=Result-Recommendation-Report-Report-Date-Time-$datenow.doc");
...
style='mso-tab-count:1'></span>: <?php echo $row['nm_customer']; ?><o:p></o:p></span></b></p>
...
1'></span>:<?php echo $row['CBC_NAME']; ?></span></b><span lang=EN-ID style='mso-ascii-font-family:
Calibri;mso-ascii-theme-font:minor-latin;mso-hansi-font-family:Calibri;
mso-hansi-theme-font:minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:
...
Calibri;mso-ascii-theme-font:minor-latin;mso-hansi-font-family:Calibri;
mso-hansi-theme-font:minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:
minor-latin'>Total Limit / Bade : <span class=SpellE></span><span
class=SpellE></span><?php echo "Rp. " . number_format($row['LIMIT_LOG'],0,',','.') ?> / <?php echo "Rp. " . number_format($row['BADE_LOG'],0,',','.') ?><o:p></o:p></span></p>
...
Calibri;mso-ascii-theme-font:minor-latin;mso-hansi-font-family:Calibri;
mso-hansi-theme-font:minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:
minor-latin'>Total limit / bade bank lain : <?php echo $row['limit_ex']; ?> / <?php echo $row['bade_bank_lain']; ?><o:p></o:p></span></p>
...
style='mso-ascii-font-family:Calibri;mso-ascii-theme-font:minor-latin;
mso-hansi-font-family:Calibri;mso-hansi-theme-font:minor-latin;mso-bidi-font-family:
Calibri;mso-bidi-theme-font:minor-latin'>Fasilitas Kredit</span></span><span
lang=EN-ID style='mso-ascii-font-family:Calibri;mso-ascii-theme-font:minor-latin;
mso-hansi-font-family:Calibri;mso-hansi-theme-font:minor-latin;mso-bidi-font-family:
Calibri;mso-bidi-theme-font:minor-latin'> :<?php echo $row['JNS_KRD']; ?><o:p></o:p></span></p>
...
lang=EN-ID style='mso-ascii-font-family:Calibri;mso-ascii-theme-font:minor-latin;
mso-hansi-font-family:Calibri;mso-hansi-theme-font:minor-latin;mso-bidi-font-family:
Calibri;mso-bidi-theme-font:minor-latin'> :<?php echo $row['BidangUsaha']; ?><o:p></o:p></span></p>
...
Calibri;mso-ascii-theme-font:minor-latin;mso-hansi-font-family:Calibri;
mso-hansi-theme-font:minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:
minor-latin'>Historical <span class=SpellE>Pembayaran</span> :<?php echo $row['HP']; ?><o:p></o:p></span></p>
                    ...
                    <?php
                      ...
                      if(mysqli_num_rows($tema)>0){
                        while($row_tema = mysqli_fetch_array($tema)) {
                            ...
                            if ($row_tema_2['report'] == 'Recommendation Report') {
                    ?>
