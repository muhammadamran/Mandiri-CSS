...
<body class="skin-blue">
  <div class="wrapper">
    ...
    if ($role2['user_role'] != 'Administrator' && $role2['user_role'] != 'EAM' && $role2['user_role'] != 'DH' && $role2['user_role'] != 'GH')  {
     include './ac_eam.php';  
    } else {
    ?>
    <div class="content-wrapper">
      ...
      <form action="" method="POST" role="form">
        <div class="box box-warning">
          ...
          <div class="box-body">
            <div class="form-group">
              <select name="reviewer" class="form-control select2" data-placeholder="Select Reviewer" required>
            ...
            <div class="form-group">
              <select class="form-control select2" multiple="multiple" data-placeholder="Select CCR Tools" style="width: 100%;" name="status_ccr[]" required>
                <option value="">-- Select CCR Tools --</option>
                <option value="Working Paper Kualitas NAK">Working Paper Kualitas NAK</option>
                <option value="Working Paper Kualitas Kredit">Working Paper Kualitas Kredit</option>
                <option value="Working Paper Supervisi Loan Monitoring">Working Paper Supervisi Loan Monitoring</option>
              </select>
            </div>
            <div class="form-group">
              <input type="submit" name="proses" class="btn btn-warning btn-block btn-flat" value="Pilih EAM">
            </div>
          <!-- /.box-body -->
        </div>
        <!-- /.box -->
