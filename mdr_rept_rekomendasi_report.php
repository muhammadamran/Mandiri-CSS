            ...
            <div class="col-xs-12">
              <div class="box-header">
                <ol class="breadcrumb">
                  ...
                  <li class="active"><b>Recommendation Report</b></li>
                </ol>
              </div><!-- /.box-header -->
            </div>
        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <i class="fa fa-search" style="color: #1d2f61"></i><b> Sreach Data Recommendation Report</b>
                  ...
                  <div class="box-body table-responsive no-padding">
                    <table id="example1" class="table table-hover">
                      ...
                      (SELECT c.id_logbook FROM tb_parameter c WHERE c.id_logbook=a.id_logbook LIMIT 1) AS logbook 
                        ...
                        WHERE a.reviewer=".$_SESSION['userid']." AND b.report='Recommendation Report' GROUP BY b.id_logbook ORDER BY a.id_logbook DESC
                        ");   
                      if(mysqli_num_rows($result)>0){
                        ...
                        while($row = mysqli_fetch_array($result))
                        {
                          ...
                          echo "</td>";
                          echo "<td align= ''width='200'>
                          <a href='include/template/report/mdr_ex_TP-recommendation_report.php?id=$row[id_logbook]' title='Template Recommendation Report'><span class='label label-primary'><font style='font-size: 10px'>Template Recommendation Report</font></span></a>                                                  
                          <a href='include/template/report/mdr_ex_result-recommendation_report.php?id=$row[id_logbook]' title='Result Recommendation Report'><span class='label label-primary'><font style='font-size: 10px'>Result Recommendation Report</font></span></a>
                          </td>";
                          echo "</tr>";
                          ?>
