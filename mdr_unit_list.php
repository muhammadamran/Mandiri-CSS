...
{    
  ...
  $cek = mysql_query("SELECT * FROM tb_upload_logbook WHERE CBC_NAME ='$uid' AND status='No Action'");
  $num = mysql_num_rows($cek);
  if($num == 1){
    $query = mysql_query("UPDATE tb_upload_logbook set status ='On Progress' where CBC_NAME ='$uid' AND status='No Action'");
    if($query){
      ...
      <section class="content">
        <div class="row">
              ...
              <div class="box-header">
                ...
                <div class="box box-default collapsed-box">
                  <div class="box-header with-border">
                    <h3 class="box-title">List data of : <b><?php echo $_GET['unit'];?></b></h3>
          ...
          // $result = mysqli_query($con,"SELECT * FROM tb_logbook ". (($query1 != '') ? " where $query1 " : " GROUP BY CBC_NAME");    
                    $result = mysqli_query($con,"SELECT * FROM tb_upload_logbook WHERE CBC_NAME = '$_GET[unit]' AND status='No Action'");    
                            ...
                            <div class="modal-body">
                              <form method="post" action=" ">
                                <div class="form-group">
                                  <label>Are you sure pick this record?</label>
                                </div>
                                <button type="submit" name="pick" class="btn btn-default">Pick</button>
